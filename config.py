...
manyTimesTrainFirstPath = r"/home/joe/JoeFilesCollections/cap-pytorch/DataSet/MouthCancerDataSet/LabDataSet/makedTifSet/2"
#the train path for a single data to training(run train_base.py)
train_path = r'/home/joe/JoeFilesCollections/cap-pytorch/DataSet/MouthCancerDataSet/LabDataSet/makedTifSet/5/train'
#the test path for a single data to training(run train_base.py)
test_path = r'/home/joe/JoeFilesCollections/cap-pytorch/DataSet/MouthCancerDataSet/LabDataSet/makedTifSet/5/test'
